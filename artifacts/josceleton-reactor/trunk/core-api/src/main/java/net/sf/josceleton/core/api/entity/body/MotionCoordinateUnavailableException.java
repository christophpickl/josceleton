...
public class MotionCoordinateUnavailableException extends JosceletonException {
	...
	protected MotionCoordinateUnavailableException(final String message, final Throwable cause, final BodyPart part) {
		super(message, cause);
		this.part = part;
	}
	 ...
	 * @since 0.4
	 */
	public static MotionCoordinateUnavailableException newUnavailable(final BodyPart part) {
		return MotionCoordinateUnavailableException.newUnavailable(part, null);
	}

	/**
	 * @since 0.4
	 */
	public static MotionCoordinateUnavailableException newUnavailable(final BodyPart part, final Throwable cause) {
