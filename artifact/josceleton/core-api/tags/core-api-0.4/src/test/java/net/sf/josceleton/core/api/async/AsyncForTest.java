...
public abstract class AsyncForTest extends AbstractMockeryTest {
	// <K, L extends Listener, A extends AsyncFor<K, L>>
	...
	@Test public final void twoDifferent() {
	...
	@Test public final void repeatedInvocationsWithSameKeyAndListener() {
		...
		testee.addListenerFor(key, listener);
		this.assertListenersCount(testee, key, 1); // still one
