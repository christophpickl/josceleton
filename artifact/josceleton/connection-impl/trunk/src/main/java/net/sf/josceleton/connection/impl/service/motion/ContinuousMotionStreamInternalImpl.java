 ...
 * @since 0.5
 */
class ContinuousMotionStreamInternalImpl
	extends DefaultAsync<MotionStreamListener>
		implements ContinuousMotionStreamInternal {
	...
	@Inject ContinuousMotionStreamInternalImpl(
			@Assisted final MotionStream internalStream,
